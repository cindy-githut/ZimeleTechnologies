...
public class FlightInformation extends AppCompatActivity {
    ...
    private void populateListWithData(String url) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                try{
                    FlightInformation.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(FlightInformation.this, "No internet connection", Toast.LENGTH_SHORT).show();
                        }
                    });
                }catch(Exception exc){
                    ...
                    FlightInformation.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (response.isSuccessful()) {
                                ...
                                Toast.makeText(FlightInformation.this, "Something went wrong please, try again later.", Toast.LENGTH_SHORT).show();
    ...
    private void handleServerResponse(JSONObject jsonObject) throws JSONException, ParseException {
        ...
        try{
            ...
            flightsAdapter = new PlainAdapter(flightsList, FlightInformation.this);
